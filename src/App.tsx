...
import { FeesOverview, ChildFees, PaymentFlow, PaymentHistory, ReceiptDownload } from "./pages/parent/fees";
import {
          ...
          <AuthProvider>
            <SessionProvider>
              ...
              <Routes>
                ...
                <Route path="/admin/students/:admissionNumber/edit" element={<EditStudent />} />
                <Route path="/admin/staff" element={<StaffList />} />
                <Route path="/admin/staff/add" element={<AddStaff />} />
                <Route path="/admin/staff/:staffId/edit" element={<EditStaff />} />
                ...
                <Route path="/admin/classes/:classId/edit" element={<EditClass />} />
                <Route path="/admin/classes/:classId" element={<ClassDetails />} />
                <Route path="/admin/classes/:classId/subjects" element={<ClassSubjects />} />
                <Route path="/admin/classes/:classId/bulk-transfer" element={<BulkTransfer />} />
                ...
                <Route path="/admin/results/verification" element={<ResultsVerification />} />
                <Route path="/admin/results/report-cards" element={<ReportCards />} />
                ...
                <Route path="/parent/fees/:studentId/pay" element={<PaymentFlow />} />
                <Route path="/parent/fees/:studentId/history" element={<PaymentHistory />} />
                <Route path="/parent/fees/:studentId/receipt/:paymentId" element={<ReceiptDownload />} />
                ...
                <Route path="/bursary/fee-collections" element={<FeeCollections />} />
                <Route path="/bursary/invoices" element={<InvoiceList />} />
                <Route path="/bursary/invoices/generate" element={<GenerateInvoice />} />
                <Route path="/bursary/expenses" element={<Expenses />} />
                <Route path="/bursary/income" element={<IncomeRecords />} />
                <Route path="/bursary/payments/reconciliation" element={<PaymentReconciliation />} />
                <Route path="/bursary/payments/reports" element={<PaymentReports />} />
