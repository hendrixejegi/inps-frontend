...
export default function BookPrices() {
  ...
  const updateMutation = useMutation({
    mutationFn: ({ id, data }: { id: string; data: any }) => bursaryApi.updateBookPrice(id, data),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["bursary-book-prices"] });
  ...
  const handleDelete = (id: string) => {
    if (confirm("Are you sure you want to delete this book price?")) {
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-1">Manage textbook prices for students</p>
          </div>
              ...
              <form onSubmit={handleCreateSubmit} className="space-y-4">
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={formData.classLevel} onValueChange={(value) => setFormData({ ...formData, classLevel: value })} required>
                      <SelectTrigger>
